...
@@ -0,0 +1,697 @@
#created by adi
#tottaly written by king hridoy
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
logo ="""  \033[1;92m _______  _______    _______  ______  _________
 ...
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |  ____  ____  | || |  _______     | || |     _____    | || |  ________    | || |  ________    | || | _____  _____ | |
| | |_   ||   _| | || | |_   __ \    | || |    |_   _|   | || | |_   ___ `.  | || | |_   ___ `.  | || ||_   _||_   _|| |
| |   | |__| |   | || |   | |__) |   | || |      | |     | || |   | |   `. \ | || |   | |   `. \ | || |  | |    | |  | |
| |   |  __  |   | || |   |  __ /    | || |      | |     | || |   | |    | | | || |   | |    | | | || |  | '    ' |  | |
| |  _| |  | |_  | || |  _| |  \ \_  | || |     _| |_    | || |  _| |___.' / | || |  _| |___.' / | || |   \ `--' /   | |
| | |____||____| | || | |____| |___| | || |    |_____|   | || | |________.'  | || | |________.'  | || |    `.__.'    | |
| |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
/
\033[1;97m====================================================
\033[1;97m[+]\033[1;91m    AUTHOR   \033[1;90m: \033[1;92mhriddu
\033[1;97m[+]\033[1;91m    FACEBOOK \033[1;90m: \033[1;92100086878986710
\033[1;97m[+]\033[1;91m    WHATSAPP \033[1;90m: \033[1;92m+8801608426376
\033[1;97m====================================================
\x1b[31;1m   \x1b[47;2m[ THIS TOOL IS PAID ]\x1b[00;1m\x1b[31;1m \x1b[31;1m \x1b[47;2m[ POWERED BY king hridoy ]\x1b[00;1m\x1b[31;1m
\033[1;97m===================================================="""
clear()
os.system("xdg-open https://www.facebook.com/profile.php?id=100086878986710")
xxxx = str(len(ugen))
